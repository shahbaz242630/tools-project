...
| [0030](0030-a-development-escape-hatch-for-the-admin-second-factor.md)                  | Give the admin second factor a development escape hatch                                    | **Superseded by 0053**                     |
...
| [0045](0045-search-pages-by-number-not-by-cursor.md)                                    | Page search by number, not by a cursor carrying an exact distance                          | Accepted                                   |
| [0046](0046-the-category-filter-is-a-predicate-not-a-second-pass.md)                    | Filter category inside the radius query; compose an absent filter to nothing               | Accepted — extends 0044                    |
| [0047](0047-a-period-costs-the-cheapest-cover-from-the-owners-rates.md)                 | Price a period as the cheapest cover from the owner's own rates; no platform curve         | Accepted                                   |
| [0048](0048-scheduled-work-is-triggered-over-an-internal-route-with-a-shared-secret.md) | Schedule in the worker, work in the API, crossed by an internal route and a shared secret  | Accepted                                   |
| [0049](0049-search-reads-bookings-availability-as-a-predicate.md)                       | Search reads Booking's blocks and bookings as a predicate, inside the radius query         | Accepted — extends 0044 and 0046           |
| [0050](0050-a-machine-calling-the-api-proves-what-it-can-and-that-differs-by-route.md)  | A machine caller proves what it can, per route — and Phase 5 verifies payments at the API  | Accepted — settles 0048 against web-env.ts |
| [0051](0051-the-ledger-is-the-record-and-the-provider-is-a-channel.md)                  | The ledger is the accounting record; a payment provider is only a channel that executes it | Accepted — binds Phase 5, applies 0002     |
| [0052](0052-the-applied-excess-is-capped-and-an-unset-band-means-no-security.md)        | Cap the applied excess at the recovery ceiling; an unset band means no security required   | Accepted — binds 5.5b–d, applies 0033      |
| [0053](0053-the-admin-second-factor-is-a-port-and-the-escape-hatch-is-an-adapter.md)    | The admin second factor is a port with adapters; the escape hatch becomes one of them      | Accepted — supersedes 0030, applies 0021   |
